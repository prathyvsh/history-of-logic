...
The Discours of Descartes in its first edition appeared as the annex to Analytic Geometry. This work helped Leibniz and Newton to invent mathematical analysis (differential and integral calculus). That gigantic step toward the integration of mathematics aroused such an admiration and such hopes in the contemporaries that the second half of the 17th century was animated by the vision of a future science, termed mathesis universalis, which would cover the whole of knowledge, philosophy incuded, in the form of a single mathematized theory.
