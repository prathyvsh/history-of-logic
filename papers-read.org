...
Theory of terms or concepts, their combination into judgements, and the composition of syllogisms from judgments. (Roughly: Primitives -> Interpretive statements -> Structures).
...
Thus modern propositions are not judgements but contents of judgments.
